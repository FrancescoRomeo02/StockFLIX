...
function mail_send($mail_mittente, $mail_destinatario, $mail_link, $messaggio)
{
    ...
    $message .= '<p style="color: #333;font-family: &quot;Muli&quot;, sans-serif;margin-bottom: 15px;padding: 2%;">Gentile ' . $mail_destinatario . ', <br> La registrazione a StockFLIX è avvenuta con successo, <br> per confermare il tuo account fai click sul link che segue: <br></p>';
